...
export default function About() {
  return (
    <div id="sobre" className="bg-slate-900/60 border border-white/10 rounded-3xl p-6 sm:p-8 flex flex-col h-full">
      <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-blue-400 mb-5">
      ...
      <div className="flex flex-col sm:flex-row gap-5 items-center text-center sm:text-left mb-7">
        ...
        />
        <div>
          <h3 className="text-xl font-bold text-white mb-2">Prazer, Leandro Castro</h3>
      ...
      <a
        href="#contato"
        className="mt-auto pt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-400 hover:text-blue-300 transition-colors"
      >
